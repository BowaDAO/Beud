...
export const faqData = [
  {
    ...
    answer:
      "Beuder is a tech ecosystem on a mission to foster the birth of more problem-solving, global-standard products in Africa.",
  },
  {
    question: "Who Can Join Beuder?",
    answer:
      "Beuder is home to both tech and non-tech talents. We bring together individuals with unique problem-solving ideas and exceptionally skilled talents to build commercial products. To mention a few tech professionals: software engineers, web developers, frontend engineers, backend engineers, DevOps engineers, product designers, UI UX designers, copywriters, technical writers, product managers, project managers, cloud engineers, etc.  ",
  },
  {
    question: "How Does The Ecosystem Operate?",
    answer:
      "1. Individuals with brilliant product ideas will submit brief proposals telling the ecosystem about the problems they intend to solve. 2. Industry experts will vet the proposals to select the ones with great potential. 3. We will form a robust team of talents to build the product MVP.",
  },
  {
    question: "How Do You Vet Tech Talents?",
    answer:
